...
15. **Аффинное пространство** — это множество точек, для которых определена векторная структура на разностях точек. Оно допускает операции вычитания точек и прибавления вектора к точке.

16. **Репер (точечный базис) аффинного пространства** — это выбор одной точки (начала) и набора линейно независимых векторов свободного векторного пространства, связанных с этим пространством.
