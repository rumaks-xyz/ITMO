...
$$
\lim_{\Delta x \to 0} \frac{\Delta f}{\Delta x} = f'(x_0) + 0 = f'(x_0).
$$
...
$$
\begin{align*}
&[f(x_0) + \Delta f] g(x_0) - f(x_0) [g(x_0) + \Delta g] \\
...
$$
\lim_{\Delta x \to 0} \frac{\sin(x + \Delta x) - \sin x}{\Delta x} = \lim_{\Delta x \to 0} \frac{2 \cos\left( x + \frac{\Delta x}{2} \right) \sin \frac{\Delta x}{2}}{\Delta x} = \cos x \cdot \lim_{\Delta x \to 0} \frac{\sin \frac{\Delta x}{2}}{\frac{\Delta x}{2}} = \cos x \cdot 1 = \cos x.
$$
...
$$
\frac{dy}{dx} = \psi'(\phi^{-1}(x)) \cdot \left(\phi^{-1}\right)'(x).
$$

По теореме о производной обратной функции:

$$
\left(\phi^{-1}\right)'(x) = \frac{1}{\phi'(\phi^{-1}(x))}.
$$
